...
app.post("/books", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newBook = yield pool.query("INSERT INTO books (title, author) VALUES($1, $2) RETURNING *", [title, author]);
...
app.get("/books/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const book = yield pool.query("SELECT * FROM books WHERE book_id = $1", [id]);
...
app.put("/books/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { title, author } = req.body;
        const updateBook = yield pool.query("UPDATE books SET title = $1, author = $2 WHERE book_id = $3", [title, author, id]);
...
app.delete("/books/:id", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const deleteBook = yield pool.query("DELETE FROM books WHERE book_id = $1", [id]);
